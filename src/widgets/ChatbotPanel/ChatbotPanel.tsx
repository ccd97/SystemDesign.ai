  ...
  return (
    <div className="chatbot-message chatbot-message--assistant">
      <div className="chatbot-typing">
        <span className="chatbot-typing-dot chatbot-typing-dot--1" />
        <span className="chatbot-typing-dot chatbot-typing-dot--2" />
        <span className="chatbot-typing-dot chatbot-typing-dot--3" />
      </div>
    </div>
  );
}
